-- SELECT TOP 10 * FROM vwRptByMonthFreeManufacturers
CREATE VIEW [dbo].[vwRptByMonthFreeManufacturers]
AS
WITH FreeManufacturers AS
(
	SELECT DISTINCT
		'Free Manufacturers' AS Type
