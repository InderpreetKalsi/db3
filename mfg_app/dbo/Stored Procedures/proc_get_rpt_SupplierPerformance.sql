...
/*
EXEC proc_get_rpt_SupplierPerformance
	@parRange	= 'Last 7 Days'
	,@parStartDate	 = '2022-01-01'
	,@parEndDate	 = '2022-10-03'


*/

CREATE PROCEDURE [dbo].proc_get_rpt_SupplierPerformance
(
...
BEGIN
	...
	(
		...
		UNION
		SELECT company_id FROM #tmpRptSupplierPerformanceActiveSupplier_buyerssavedtocontacts
		UNION
