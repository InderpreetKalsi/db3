...
insert into @p25 values(7491)
EXEC proc_get_supplier_child_capabilities @supplier_company_id = 1799152 ,  @type = 'RFQSearch' ,@processids = @p25

*/
CREATE PROCEDURE [dbo].[proc_get_supplier_child_capabilities]
(
